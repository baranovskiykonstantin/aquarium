...
Топология печатной платы разведена не полностью, необнодымо припаять три перемычки указанные красным пунктиром.<br>
Индикатор перевернут (установлен вверх ногами по ошибке). Так как он симетричен и десятичные точки не задействованы (используется только двоеточие по-середине), то проблемы это не составляет.
